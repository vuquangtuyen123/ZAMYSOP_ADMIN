...
<div class="noi-dung-chinh">
    ...
    <div class="noi-dung-dashboard">
        ...
        <form method="POST" action="index.php?c=news&a=them" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="trang_thai_hien_thi" id="trang_thai_hien_thi" value="1"> Hiện
            </div>
            <button type="submit" class="them-moi-btn">Lưu</button>
        </form>
    </div>
</div>